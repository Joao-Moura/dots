...
_G.packer_plugins = {
  ...
  decay = {
    loaded = true,
    path = "/home/joao/.local/share/nvim/site/pack/packer/start/decay",
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'todo-comments.nvim', 'kommentary', 'telescope.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
